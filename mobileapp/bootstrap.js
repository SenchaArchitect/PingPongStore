...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Fulfill.DirectAPI": [],
  "Fulfill.controller.NavController": [],
  "Fulfill.model.Employee": [],
  "Fulfill.model.Item": [],
  "Fulfill.model.LineItem": [],
  "Fulfill.model.Orders": [],
  "Fulfill.override.chart.Legend": [],
  "Fulfill.store.EmployeesStore": [],
  "Fulfill.store.ItemsStore": [],
  "Fulfill.store.LineItemsStore": [],
  "Fulfill.store.OrdersByItemStore": [],
  "Fulfill.store.OrdersStore": [],
  "Fulfill.store.PieChartDataStore": [],
  "Fulfill.store.SalesHistoryStore": [],
  "Fulfill.view.Dashboard": [],
  "Fulfill.view.EmployeeEdit": [],
  "Fulfill.view.EmployeeList": [],
  "Fulfill.view.EmployeesNavView": [],
  "Fulfill.view.Home": [],
  "Fulfill.view.ItemDetail": [],
  "Fulfill.view.ItemList": [],
  "Fulfill.view.ItemPick": [],
  "Fulfill.view.ItemsNavView": [],
  "Fulfill.view.Main": [],
  "Fulfill.view.OrderConfirm": [],
  "Fulfill.view.OrderDetail": [],
  "Fulfill.view.OrderList": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Fulfill.view.OrdersNavView": [
    "widget.ordersnavview"
  ],
  "Fulfill.view.PieBreakdown": [
    "widget.pieBreakdown"
  ],
  "Fulfill.view.SalesHistoryChart": [
    "widget.saleshistorychart"
  ]
});
