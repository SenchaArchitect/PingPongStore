...
var panel = new Ext.panel.Panel({
    ...
    initBodyStyles: function() {
        ...
        if (me.bodyPadding !== undefined) {
            if (me.layout.managePadding) {
                ...
                body.setStyle('padding', Ext.Element.unitizeBox((me.bodyPadding === true) ? 5 : me.bodyPadding));
            }
        }
        me.initBodyBorder();
    },
    ...
    initBodyBorder: function() {
        ...
        if (me.frame && me.bodyBorder) {
            ...
            me.getProtoBody().setStyle('border-width', Ext.Element.unitizeBox(me.bodyBorder));
        }
    },
